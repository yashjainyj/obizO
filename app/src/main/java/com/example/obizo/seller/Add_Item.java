        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }else
                {
                    ...
                    final TextInputEditText editText[]= {findViewById(R.id.item_name),findViewById(R.id.weight),findViewById(R.id.quantity),findViewById(R.id.price),findViewById(R.id.description)};
