...
public class Add_Shop extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final TextInputEditText[] textInputEditTexts = {findViewById(R.id.shop_name),findViewById(R.id.shop_address),findViewById(R.id.min),findViewById(R.id.raiting),findViewById(R.id.shop_phone)};
